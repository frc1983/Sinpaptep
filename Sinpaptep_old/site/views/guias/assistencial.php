...
<h1>Contribuição Assistencial</h1>
...
?>
<input type="hidden" name="msgCompensacao1" size="60" maxlength="60" value="">
<input type="hidden" name="msgCompensacao2" size="60" maxlength="60" value="Após vencimento, pagável apenas nas agências da Caixa">
