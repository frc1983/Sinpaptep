...
var BAR_BLACK  = "<img src='BoletoWebCaixa/images/black.jpg' height='"+BAR_HEIGHT+"' width="+BAR_WIDTH+">";
var BAR_WHITE  = "<img src='BoletoWebCaixa/images/white.jpg' height='"+BAR_HEIGHT+"' width="+BAR_WIDTH+">";
var BAR_3BLACK = "<img src='BoletoWebCaixa/images/black.jpg' height='"+BAR_HEIGHT+"' width="+(BAR_WIDTH*3)+">";
var BAR_3WHITE = "<img src='BoletoWebCaixa/images/white.jpg' height='"+BAR_HEIGHT+"' width="+(BAR_WIDTH*3)+">";
