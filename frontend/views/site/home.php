                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <?php if ($noticia->imagem): ?>
                                <img src="<?= Html::encode($noticia->imagem->getUrlComPrefixo()) ?>" style="max-width:100%; height:auto; margin-bottom:10px;">
                            <?php endif; ?>
        ...
        <?php foreach ($anunciantes as $anunciante): ?>
            <div style="margin-bottom:20px;">
                <a href="<?= Html::encode($anunciante->Site) ?>" target="_blank">
                    ...
                    ?>
                        <img src="<?= Html::encode($primeiraImagem->getImagemUrl()) ?>" style="width:100%; max-width:250px;">
                    <?php else: ?>
